    ...
    if (isset($_POST['submit'])) {
        ...
        $nationalityaa = $_POST['nationality'];
        $emaill =  $_POST['email'];
        $placeofbirthaa = $_POST['placeofbirth'];
        $directoratyeaa = $_POST['directoratye'];
        $datebirthaa = $_POST['datebirth'];
        $studentservicesaa = $_POST['studentservices'];
        $files = $_FILES['image'];
        ...
        if (in_array($filecheck, $fileextstored) && in_array($filechecking, $fileextstored) && in_array($filecheckala, $fileextstored)  && in_array($filecheckab, $fileextstored)  && in_array($filecheckcd, $fileextstored)  && in_array($filecheckef, $fileextstored)  && in_array($filecheckgh, $fileextstored)  && in_array($filecheckij, $fileextstored)  && in_array($filecheckkl, $fileextstored)  && in_array($filecheckmn, $fileextstored)) {
            ...
            $q = " INSERT INTO  genderal (uname,nationality,email,placeofbirth,directoratye,datebirth,studentservices,image,imageing,ingala,ab,cd,ef,gh,ij,kl,mn) VALUES('$username','$nationalityaa','$emaill','$placeofbirthaa','$directoratyeaa','$datebirthaa','$studentservicesaa','$destinationfile','$destinationfileing','$destinationfileala','$destinationab','$destinationfilecd','$destinationfileef','$destinationfilegh','$destinationfileij','$destinationfilekl','$destinationfilemn')";
    ...
    header("Location:indecsearch.php");
    ?>
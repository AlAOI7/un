...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/logdo.css">
...
<body>
    ...
    <div class="loginbox">
        ...
        <img src="img/l1.jpg" class="avater">
        <h1> ادارة الوثائق تسجيل
            <br>
            دخول الموظف
        </h1>
        <form action="" method="post">
            ...
            <center>
                <p>اسم المستخدم </p>
                <input type="username" name="username" placeholder="أدخل اسم المستخدم">
                <p>كلمة السر</p>
                <input type="password" name="passs" placeholder="ادخل كلمة السر">
        ...
        if (isset($_POST['login'])) {
            ...
            $pass = $con->real_escape_string($_POST['passs']);
            $query = "SELECT * FROM adminducument WHERE username = '$uname' AND passs = '$pass'";
            $rs = $con->query($query);
            $num = $rs->num_rows;
            $rows = $rs->fetch_assoc();
            if ($num > 0) {
                ...
                $_SESSION['passs'] = $rows['passs'];
                echo "<script type = \"text/javascript\">
         
            window.location = (\"admin_document/indexduc.php\")
            </script>";
            } else {
                echo "<script type = \"text/javascript\">
